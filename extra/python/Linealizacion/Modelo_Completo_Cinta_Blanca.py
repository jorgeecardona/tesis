...
m       = 1.013  # MAsa conjunta de la polea y el pivote para efectos de torque.
Y       = 3.744* 1e6   # Modulo de Young de la cinta
...
k_f     = 8.9182 / 10   # Constante de friccion
L_k     = 2.5    # Ver Diagramas del modelo
rho_o   = 1.2157 * 1000  # Densidad de la cinta en reposo
rho_e   = 1.041 * 1000  # Densidad de la cinta por fuera del sistema
g       = 9.81   # Gravedad
I       = 13.9720 / 100  # Inercia del pivote
